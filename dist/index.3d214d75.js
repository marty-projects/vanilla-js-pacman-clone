...
var _ghostMovesJs = require("./GhostMoves.js");
var _gameboardJs = require("./Gameboard.js");
var _gameboardJsDefault = parcelHelpers.interopDefault(_gameboardJs);
var _pacmanJs = require("./Pacman.js");
var _pacmanJsDefault = parcelHelpers.interopDefault(_pacmanJs);
var _ghostJs = require("./Ghost.js");
var _ghostJsDefault = parcelHelpers.interopDefault(_ghostJs);
var _munchMp3 = require("./static/sounds/munch.mp3");
var _munchMp3Default = parcelHelpers.interopDefault(_munchMp3);
var _pillMp3 = require("./static/sounds/pill.mp3");
var _pillMp3Default = parcelHelpers.interopDefault(_pillMp3);
var _gameStartMp3 = require("./static/sounds/game_start.mp3");
var _gameStartMp3Default = parcelHelpers.interopDefault(_gameStartMp3);
var _deathMp3 = require("./static/sounds/death.mp3");
var _deathMp3Default = parcelHelpers.interopDefault(_deathMp3);
var _eatGhostMp3 = require("./static/sounds/eat_ghost.mp3");
var _eatGhostMp3Default = parcelHelpers.interopDefault(_eatGhostMp3);
//DOM
...
const gameboard = (0, _gameboardJsDefault.default).createGameboard(gameGrid, (0, _setupJs.LEVEL));
//Initialize
let score = 0;
let timer = null;
let gameWin = false;
...
function gameOver(pacman) {
    playAudio((0, _deathMp3Default.default));
    document.removeEventListener("keydown", (e)=>pacman.handleKeyInput(e, gameboard.objectExists.bind(gameboard)));
...
function checkCollision(pacman, ghosts) {
    ...
    if (collidedGhost) {
        if (pacman.powerPill) {
            playAudio((0, _eatGhostMp3Default.default));
            gameboard.removeObject(collidedGhost.pos, [
                (0, _setupJs.OBJECT_TYPE).GHOST,
                (0, _setupJs.OBJECT_TYPE).SCARED,
                collidedGhost.name
            ]);
...
function startGame() {
    playAudio((0, _gameStartMp3Default.default));
    gameWin = false;
    powerPillActive = false;
    score = 0;
    startButton.classList.add("hide");
    gameboard.createGrid((0, _setupJs.LEVEL));
    const pacman = new (0, _pacmanJsDefault.default)(2, 287);
    ...
    const ghosts = [
        ...
        new (0, _ghostJsDefault.default)(3, 230, (0, _ghostMovesJs.randomMovement), (0, _setupJs.OBJECT_TYPE).INKY),
        new (0, _ghostJsDefault.default)(2, 251, (0, _ghostMovesJs.randomMovement), (0, _setupJs.OBJECT_TYPE).CLYDE)
    ];
...
},{"./setup":"b1uhz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cc3pp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _setup = require("./setup");
class Gameboard {
...
class Pacman {
    ...
    getNextMove(objectExists) {
        ...
        if (objectExists(nextMovePos, (0, _setup.OBJECT_TYPE).WALL) || objectExists(nextMovePos, (0, _setup.OBJECT_TYPE).GHOSTLAIR)) nextMovePos = this.pos;
        return {
            nextMovePos,
            direction: this.dir
        };
...
},{}],"l7ByZ":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("UckoE") + "pill.14b5b620.mp3" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"b7EE7":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("UckoE") + "game_start.b951fbc5.mp3" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"gI3Gq":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("UckoE") + "death.cf241a8a.mp3" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"hfxeT":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("UckoE") + "eat_ghost.29fadfc0.mp3" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequire5fed")
